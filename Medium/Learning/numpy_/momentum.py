...
if __name__ == '__main__':
    mombt = MomVectorBacktester('AAPL.O', '2010-1-1', '2019-12-31', 10000, 0.0)
    print(mombt.run_strategy(momentum=1))
    print(mombt.run_strategy(momentum=2))
    # print(mombt.run_strategy(momentum=3))
    # print(mombt.run_strategy(momentum=4))
    # print(mombt.run_strategy(momentum=5))
    # print(mombt.run_strategy(momentum=6))
